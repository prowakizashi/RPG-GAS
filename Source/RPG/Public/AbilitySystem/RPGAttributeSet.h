...
USTRUCT()
struct RPG_API FEffectProperties
{
	GENERATED_BODY()
public:
...
// Function pointer that return a FGameplayAttribute:
// typedef TBaseStaticDelegateInstance<FGameplayAttribute(), FDefaultDelegateUserPolicy>::FFuncPtr FAttributeFuncPtr;
// It's constructed like this:
// typedef "StaticOrMemberTypeOfFunction"<ReturnType(ListOfParams...), FDefaultDelegateUserPolicy>::FFuncPtr FNameOfType;
// same as above, but templated to any returning type:
template<class T>
...
public:
	...
	FORCEINLINE const TStaticFuncPtr<FGameplayAttribute()>* GetAttributeByTag(const FGameplayTag& GameplayTag) const { return TagsToAttributes.Find(GameplayTag); }
	FORCEINLINE const TMap<FGameplayTag, TStaticFuncPtr<FGameplayAttribute()>>& GetTagsToAttributes() const { return TagsToAttributes; }
	...
	*/
	...
	/**
	 * Meta Attributes (we make them not replicating)
	 */
...
private:
	...
	void HandleIncommingDamage(const FEffectProperties& EffectProps);
	void HandleIncommingXp(const FEffectProperties& EffectProps);
